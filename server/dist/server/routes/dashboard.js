...
router.get('/readiness', async (req, res) => {
    try {
        ...
        const readiness = await DashboardAnalyticsService.getReadinessSnapshot(tenantId, assessmentId);
        res.json({
            success: true,
            readiness,
        });
...
router.get('/gaps/:assessmentId', async (req, res) => {
    try {
        ...
        const gapAnalysis = await DashboardAnalyticsService.getGapAnalysis(tenantId, assessmentId);
        res.json({
            success: true,
            gapAnalysis,
        });
...
router.get('/activity', async (req, res) => {
    try {
        ...
        const activities = await DashboardAnalyticsService.getActivityFeed(tenantId, limit);
        res.json({
            success: true,
            activities,
