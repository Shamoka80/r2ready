...
router.post('/facility-baseline', async (req, res) => {
    try {
        const tenantId = req.user.tenantId;
...
router.post('/scope-applicability', async (req, res) => {
    try {
        const tenantId = req.user.tenantId;
...
router.put('/facility-baseline', async (req, res) => {
    try {
        const tenantId = req.user.tenantId;
...
router.put('/scope-applicability', async (req, res) => {
    try {
        const tenantId = req.user.tenantId;
...
router.post('/complete', async (req, res) => {
    try {
        ...
        await AuthService.logAuditEvent(req.user.tenantId, userId, 'ONBOARDING_COMPLETED', 'user', userId, { previousStatus: 'setup_incomplete' }, {
