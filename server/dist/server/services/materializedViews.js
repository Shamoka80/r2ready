...
import { refreshClientOrgStatsSQL, clientOrgStatsViewSQL, refreshAssessmentStatsSQL, assessmentStatsViewSQL } from '../../shared/schema';
/**
...
export class MaterializedViewService {
     ...
     */
    static async refreshClientOrgStats() {
        try {
     ...
     */
    static async createClientOrgStatsView() {
        try {
     ...
     * Uses REFRESH MATERIALIZED VIEW CONCURRENTLY to avoid locking
     */
    static async refreshAssessmentStats() {
        try {
     ...
     * This is called automatically if the view doesn't exist when trying to refresh
     */
    static async createAssessmentStatsView() {
        try {
