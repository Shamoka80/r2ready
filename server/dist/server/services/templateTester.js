...
export class TemplateGoldenFileTester {
    ...
    testSuitesPath;
    goldenFilesPath;
    constructor(templateValidator, templateProcessor, testSuitesPath) {
    ...
    async testTemplate(templateName, suite) {
        const warnings = [];
        try {
    ...
    async generateTemplateOutput(templateName, testData) {
        try {
    ...
    async performContentChecks(outputBuffer, contentChecks) {
        const failures = [];
        try {
    ...
    async saveGoldenFile(templateName, outputBuffer, checksum) {
...
export const templateTester = new TemplateGoldenFileTester(new TemplateValidator(), new TemplateProcessor());
