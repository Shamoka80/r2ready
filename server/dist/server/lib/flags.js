...
export function flagsMiddleware(req, res, next) {
...
export async function withFlag(flag, context, ifEnabled, ifDisabled) {
...
export class FlagAdminAPI {
    ...
    static async getGlobalFlags() {
        return await flagService.getFlags();
    }
    // Set global flag
    static async setGlobalFlag(flag, value) {
        if (value) {
    ...
    static async setTenantFlag(tenantId, flag, value) {
        if (value) {
    ...
    static async enableForInternalTenants(flags, internalTenantIds) {
    ...
    static async enableForPercentage(flag, percentage, tenantIds) {
