...
router.post('/roles', async (req: AuthenticatedRequest, res) => {
  try {
...
router.delete('/roles/:roleId', async (req: AuthenticatedRequest, res) => {
  try {
...
router.get('/roles/:roleId/permissions', async (req: AuthenticatedRequest, res) => {
  try {
    const { roleId } = req.params;
...
router.post('/roles/:roleId/permissions', async (req: AuthenticatedRequest, res) => {
  try {
    const { roleId } = req.params;
...
router.delete('/roles/:roleId/permissions/:permissionId', async (req: AuthenticatedRequest, res) => {
  try {
