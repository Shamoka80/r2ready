...
import { FeatureFlag } from '../../shared/flags.js';
...
router.post('/admin/flags', async (req: any, res) => {
  try {
    ...
    await FlagAdminAPI.setGlobalFlag(flag as FeatureFlag, value);
...
router.post('/admin/tenants/:tenantId/flags', async (req, res) => {
  try {
    ...
    await FlagAdminAPI.setTenantFlag(tenantId, flag as FeatureFlag, value);
