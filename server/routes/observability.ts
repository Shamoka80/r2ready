...
import { rateLimitMiddleware, strictRateLimit } from '../middleware/rateLimitMiddleware';
 ...
 */
router.get('/performance', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
 ...
 */
router.get('/cache/stats', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
 ...
 * Clear cache
 */
router.post('/cache/clear', AuthService.authMiddleware, strictRateLimit.adminActions, async (req: AuthenticatedRequest, res) => {
 ...
 */
router.get('/logs', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  const logger = ConsistentLogService.getInstance(); // Re-instantiate logger
 ...
 */
router.get('/database/slow-queries', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
 ...
 */
router.get('/database/n-plus-one', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
 ...
 */
router.get('/database/optimization-suggestions', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
 ...
 */
router.post('/database/analyze-query', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
 ...
 */
router.post('/execute-sql', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
 ...
 */
router.get('/analytics', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
 ...
 */
router.post('/database/cleanup', AuthService.authMiddleware, strictRateLimit.adminActions, async (req: AuthenticatedRequest, res) => {
  try {
