...
router.post('/questions/filter', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
...
router.post('/corrective-actions', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
...
router.get('/corrective-actions/:assessmentId', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
...
// Milestone tracking
router.post('/milestones', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
...
router.get('/progress/:assessmentId', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
...
router.post('/templates', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
...
// Advanced scoring
router.post('/scoring/advanced', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
...
// Gap analysis
router.post('/analysis/gaps', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
    const { assessmentId } = req.body;
...
// Compliance metrics
router.post('/metrics/compliance', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
    const { assessmentId } = req.body;
...
// Predictive insights
router.post('/insights/predictive', AuthService.authMiddleware, async (req: AuthenticatedRequest, res) => {
  try {
    const { assessmentId } = req.body;
