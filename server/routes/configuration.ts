 ...
 */
router.get("/scoring-configs", async (req: AuthenticatedRequest, res: Response) => {
  try {
 ...
 */
router.get("/scoring-configs/active", async (req: AuthenticatedRequest, res: Response) => {
  try {
 ...
 */
router.get("/scoring-configs/:id", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.post("/scoring-configs", async (req: AuthenticatedRequest, res: Response) => {
  try {
 ...
 */
router.patch("/scoring-configs/:id", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.delete("/scoring-configs/:id", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.get("/must-pass-rules", async (req: AuthenticatedRequest, res: Response) => {
  try {
 ...
 */
router.get("/must-pass-rules/:id", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.post("/must-pass-rules", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const schema = z.object({
 ...
 */
router.patch("/must-pass-rules/:id", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.delete("/must-pass-rules/:id", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.post("/must-pass-rules/:id/questions", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.delete("/must-pass-rules/:ruleId/questions/:questionId", async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    const [deleted] = await db.delete(mustPassRuleQuestions)
      .where(
        and(
          eq(mustPassRuleQuestions.mustPassRuleId, ruleId),
          eq(mustPassRuleQuestions.questionId, questionId)
        )
      )
      .returning();
 ...
 */
router.get("/conditional-rules", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const rules = await db.select()
 ...
 */
router.get("/conditional-rules/:id", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.post("/conditional-rules", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const schema = z.object({
 ...
 */
router.patch("/conditional-rules/:id", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.delete("/conditional-rules/:id", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.post("/conditional-rules/:id/targets", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.delete("/conditional-rules/:ruleId/targets/:questionId", async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { ruleId, questionId } = req.params;
    ...
    const [deleted] = await db.delete(conditionalRuleTargets)
      .where(
        and(
          eq(conditionalRuleTargets.conditionalRuleId, ruleId),
          eq(conditionalRuleTargets.targetQuestionId, questionId)
        )
      )
      .returning();
