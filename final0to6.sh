# Phase 7: bootstrap + run parity E2E (covers Phases 0–6 artifacts)
cat > phase7_bootstrap_and_run.sh <<'BASH'
#!/usr/bin/env bash
set -euo pipefail
mkdir -p Fixes/qa
...
chmod +x phase7_bootstrap_and_run.sh
./phase7_bootstrap_and_run.sh